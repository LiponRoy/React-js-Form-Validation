					...
					<form
						...
						<div className='form-group '>
							...
							<div className=''>
								...
								/>
								{FormErrors.name && (
									<p className='error inputError'>{FormErrors.name}</p>
								)}
							</div>
						</div>
						...
						<div className='form-group '>
							...
							<div>
								...
								/>
								{FormErrors.email && (
									<p className='error inputError'>{FormErrors.email}</p>
								)}
							</div>
						</div>
						...
						<div className='form-group '>
							...
							<div>
								...
								/>
								{FormErrors.mobile && (
									<p className='error inputError'>{FormErrors.mobile}</p>
								)}
							</div>
						</div>
						{/* Password field */}
						<div>
							...
							<div>
								...
								/>
								{FormErrors.password && (
									<p className='error inputError'>{FormErrors.password}</p>
								)}
							</div>
						</div>
						{/* Gender */}
						...
						<div>
							...
							<div className='my-1'>
								<input
									...
									type='radio'
									checked={values.redioButton === 'one'}
									value='one'
									name='redioButton'
								...
								<input
									className='form-check-input'
									type='radio'
									checked={values.redioButton === 'two'}
									value='two'
									name='redioButton'
									onChange={handleChange}></input>
								<label className='form-check-label ml-1' htmlFor=''>
								...
								<input
									className='form-check-input'
									type='radio'
									checked={values.redioButton === 'three'}
									value='three'
									name='redioButton'
									onChange={handleChange}></input>
								<label className='form-check-label ml-1' htmlFor=''>
